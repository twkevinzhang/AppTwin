...
class MethodProxies {
    ...
    static class CheckPermission extends MethodProxy {
        ...
        public Object call(Object who, Method method, Object... args) throws Throwable {
            ...
            if (DynamicReceiverPermissionCompat.isSyntheticPermission(permission)) {
                ...
                // host UID. Report it as granted and rewrite registerReceiver() to the host's
                // equivalent signature permission below.
                return PackageManager.PERMISSION_GRANTED;
            }
    ...
    static class RegisterReceiver extends MethodProxy {
        ...
        public Object call(Object who, Method method, Object... args) throws Throwable {
            MethodParameterUtils.replaceFirstAppPkg(args);
            String requiredPermission = (String) args[mRequiredPermissionIndex];
            args[mRequiredPermissionIndex] = DynamicReceiverPermissionCompat.isSyntheticPermission(requiredPermission)
