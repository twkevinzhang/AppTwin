package org.maskaccounts.ui.theme
...
private val MaskDarkColors = darkColorScheme(
...
@Composable
fun MaskAccountsTheme(content: @Composable () -> Unit) {
    MaterialTheme(
        colorScheme = MaskDarkColors,
        shapes = MaskShapes,
        content = content,
    )
}
